### Usage Instruction
The gtest lib is already compiled and built, here is how you run test.
#### Compile test file
g++ -isystem ./directory/Of/Needed/Header -pthread yourTest.cpp ./location/of/correspondent/CPPfile/of/header.cpp -std=c++11  libgtest.a -o test.o
#### Run the test
run ./test.o
